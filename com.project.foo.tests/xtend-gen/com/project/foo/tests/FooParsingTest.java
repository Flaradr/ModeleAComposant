...
public class FooParsingTest {
  ...
  private final static String validComponent = new Function0<String>() {
    public String apply() {
      ...
      _builder.newLine();
      _builder.append("\t\t");
      _builder.append("service required type3 m3();");
      _builder.newLine();
      _builder.append("\t");
      _builder.append("}");
      _builder.newLine();
  ...
  public void testCheckComponentNameIsUnique() {
    try {
      ...
      _builder.newLine();
      _builder.append("\t\t");
      _builder.append("service provided type2 m1(p1 : type2) {foo;}");
      _builder.newLine();
      _builder.append("\t\t");
      _builder.append("service provided type1 m2(p2 : type1) {bar;}");
      _builder.newLine();
      _builder.newLine();
      _builder.append("\t\t");
      _builder.append("service required type3 m3();");
      ...
      _builder.newLine();
      _builder.append("\t\t");
      _builder.append("service provide type1 m7() {barfoo;}");
      _builder.newLine();
      _builder.append("\t");
      _builder.append("}");
      _builder.newLine();
  ...
  public void testCheckAssemblyNameIsUnique() {
    try {
      ...
      _builder.newLine();
      _builder.append("\t\t");
      _builder.append("service provided type2 m2(p1 : type2) {bar;}");
      _builder.newLine();
      _builder.append("\t");
      _builder.append("}");
      _builder.newLine();
      ...
      _builder_1.newLine();
      _builder_1.append("\t\t");
      _builder_1.append("service provided type2 m1(p1 : type2) {foo;}");
      _builder_1.newLine();
      _builder_1.append("\t");
      _builder_1.append("}");
      _builder_1.newLine();
      ...
      _builder_1.newLine();
      _builder_1.append("\t\t");
      _builder_1.append("service provided type2 m2(p1 : type2) {bar;}");
      _builder_1.newLine();
      _builder_1.append("\t");
      _builder_1.append("}");
      _builder_1.newLine();
  ...
  public void testCheckComponentAttributeNameIsUnique() {
    try {
      ...
      _builder_1.newLine();
      _builder_1.append("\t\t");
      _builder_1.append("service provided type2 m1(p1 : type2) {foobar;}");
      _builder_1.newLine();
      _builder_1.append("\t");
      _builder_1.append("}");
      _builder_1.newLine();
      ...
      _builder_1.newLine();
      _builder_1.append("\t\t");
      _builder_1.append("service provided type2 m2(p1 : type2) {barfoo;}");
      _builder_1.newLine();
      _builder_1.append("\t");
      _builder_1.append("}");
      _builder_1.newLine();
  ...
  public void testCheckRequieredServiceNameIsUnique() {
    try {
      ...
      _builder.newLine();
      _builder.append("\t\t");
      _builder.append("required = {m2,m2}");
      _builder.newLine();
      _builder.newLine();
      _builder.append("\t\t");
      _builder.append("service provided type1 m1() {foo;}");
      _builder.newLine();
      _builder.append("\t\t");
      _builder.append("service required type3 m2();");
      _builder.newLine();
      _builder.append("\t");
      _builder.append("}");
      _builder.newLine();
  ...
  public void testCheckBindingIsValid() {
    try {
      ...
      _builder.newLine();
      _builder.append("  \t\t");
      _builder.append("service required type1 m1 ();");
      _builder.newLine();
      _builder.append("  \t");
      _builder.append("}");
      _builder.newLine();
      ...
      _builder_1.newLine();
      _builder_1.append("  \t\t");
      _builder_1.append("service required type1 m1 (p1 : type1, p2 : type2);");
      _builder_1.newLine();
      _builder_1.append("  \t");
      _builder_1.append("}");
      _builder_1.newLine();
      ...
      _builder_2.newLine();
      _builder_2.append("  \t\t");
      _builder_2.append("service required type2 m1 (p1 : type1, p2 : type2);");
      _builder_2.newLine();
      _builder_2.append("  \t");
      _builder_2.append("}");
      _builder_2.newLine();
      ...
      _builder_3.newLine();
      _builder_3.append("  \t\t");
      _builder_3.append("service required type2 m1 (p1 : type1, p2 : type2, p3 : type0);");
      _builder_3.newLine();
      _builder_3.append("  \t");
      _builder_3.append("}");
      _builder_3.newLine();
  ...
  public void testCheckAssemblyIsCorrect() {
    try {
      ...
      _builder.newLine();
      _builder.append("\t\t");
      _builder.append("service required type3 m3(p2 : type4);");
      _builder.newLine();
      _builder.append("\t");
      _builder.append("}");
      _builder.newLine();
      ...
      _builder.newLine();
      _builder.append("\t\t");
      _builder.append("service required type2 m1 (p3 : type1);");
      _builder.newLine();
      _builder.append("\t");
      _builder.append("}");
      _builder.newLine();
      ...
      _builder_1.newLine();
      _builder_1.append("\t\t");
      _builder_1.append("service required type3 m3(p2 : type4);");
      _builder_1.newLine();
      _builder_1.append("\t");
      _builder_1.append("}");
      _builder_1.newLine();
      ...
      _builder_1.newLine();
      _builder_1.append("\t\t");
      _builder_1.append("service required type2 m1 (p3 : type1);");
      _builder_1.newLine();
      _builder_1.append("\t");
      _builder_1.append("}");
      _builder_1.newLine();
      ...
      _builder_2.newLine();
      _builder_2.append("\t\t");
      _builder_2.append("service required type3 m3(p2 : type4);");
      _builder_2.newLine();
      _builder_2.append("\t");
      _builder_2.append("}");
      _builder_2.newLine();
      ...
      _builder_2.newLine();
      _builder_2.append("\t\t");
      _builder_2.append("service required type2 m1 (p3 : type1);");
      _builder_2.newLine();
      _builder_2.append("\t");
      _builder_2.append("}");
      _builder_2.newLine();
  ...
  @Test
  public void testCheckBindingRequieredCanUseMethod() {
    try {
      StringConcatenation _builder = new StringConcatenation();
      ...
      _builder.newLine();
      _builder.append("\t\t");
      _builder.append("provided = {m1,m2,m8}");
      _builder.newLine();
      _builder.append("\t\t");
      _builder.append("required = {m3}");
      _builder.newLine();
      _builder.newLine();
      _builder.append("\t\t");
      _builder.append("service provided type2 m1(p1 : type1) {foo;}");
      _builder.newLine();
      _builder.append("\t\t");
      _builder.append("service provided void m2() {b;}");
      _builder.newLine();
      _builder.append("\t\t");
      _builder.append("service provided type3 m8(p8 : type3, p9 : type4) {");
      _builder.newLine();
      _builder.append("\t\t\t");
      _builder.append("while(K.equals(p) && !bar){");
      _builder.newLine();
      _builder.append("\t\t\t\t");
      _builder.append("foo;");
      _builder.newLine();
      ...
      _builder.newLine();
      _builder.append("\t\t");
      _builder.append("provided = {m3}");
      _builder.newLine();
      _builder.append("\t\t");
      _builder.append("required = {m1,m4}");
      _builder.newLine();
      _builder.newLine();
      _builder.append("\t\t");
      _builder.append("service provided type3 m3 (p4 : type4) {f; }");
      _builder.newLine();
      _builder.newLine();
      _builder.append("\t\t");
      _builder.append("service required type2 m1 (p3 : type1);");
      _builder.newLine();
      _builder.append("\t\t");
      _builder.append("service required type3 m4 (p4_1 : type3, p4_2 : type4);");
      _builder.newLine();
      _builder.append("\t");
      _builder.append("}");
      _builder.newLine();
      ...
      _builder_1.newLine();
      _builder_1.append("\t\t");
      _builder_1.append("service provided type2 m1(p1 : type1) {foo;}");
      _builder_1.newLine();
      _builder_1.append("\t\t");
      _builder_1.append("service provided void m2() {bar;}");
      _builder_1.newLine();
      _builder_1.append("\t\t");
      _builder_1.append("service provided type3 m8(p8 : type3, p9 : type4) {foobar;}");
      _builder_1.newLine();
      _builder_1.newLine();
      _builder_1.append("\t\t");
      _builder_1.append("service required type3 m3(p2 : type4);");
      ...
      _builder_1.newLine();
      _builder_1.append("\t\t");
      _builder_1.append("required = {m1,m4}");
      _builder_1.newLine();
      _builder_1.newLine();
      _builder_1.append("\t\t");
      _builder_1.append("service provided type3 m3 (p4 : type4) { foobar; }");
      _builder_1.newLine();
      _builder_1.append("\t\t");
      _builder_1.append("service required type2 m1 (p3 : type1);");
      _builder_1.newLine();
      _builder_1.append("\t\t");
      _builder_1.append("service required type3 m4 (p4_1 : type3, p4_2 : type4);");
      _builder_1.newLine();
      _builder_1.append("\t");
      _builder_1.append("}");
      _builder_1.newLine();
  ...
  @Test
  public void testCheckBindingProvidedCanUseMethod() {
    try {
      StringConcatenation _builder = new StringConcatenation();
      _builder.append("package my.company.firstPack {");
      _builder.newLine();
      ...
      _builder.newLine();
      _builder.append("\t\t");
      _builder.append("service provided type3 m3 (p4 : type4) { ");
      _builder.newLine();
      _builder.append("\t\t\t");
      _builder.append("Foo;");
      _builder.newLine();
      ...
      _builder_1.newLine();
      _builder_1.append("\t\t");
      _builder_1.append("required = {m3,mk0}");
      _builder_1.newLine();
      _builder_1.newLine();
      _builder_1.append("\t\t");
      _builder_1.append("service provided type2 m1(p1 : type1) {");
      ...
      _builder_1.newLine();
      _builder_1.append("\t\t\t");
      _builder_1.append("if (!false && k.equals(bar)){");
      _builder_1.newLine();
      _builder_1.append("\t\t\t\t");
      _builder_1.append("foo;");
      _builder_1.newLine();
      ...
      _builder_1.newLine();
      _builder_1.append("\t\t");
      _builder_1.append("service required type00 mk0();");
      _builder_1.newLine();
      _builder_1.append("\t");
      _builder_1.append("}");
      _builder_1.newLine();
