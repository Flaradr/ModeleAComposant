		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getIfAccess().getGroup_6_0(), "rule__If__Group_6_0__0");
					...
					put(grammarAccess.getIfAccess().getGroup_8_1_1_1_0(), "rule__If__Group_8_1_1_1_0__0");
					...
					put(grammarAccess.getWhileAccess().getGroup_6_0(), "rule__While__Group_6_0__0");
					...
					put(grammarAccess.getIfAccess().getStrAssignment_6_0_0(), "rule__If__StrAssignment_6_0_0");
					...
					put(grammarAccess.getIfAccess().getStrAssignment_8_1_1_1_0_0(), "rule__If__StrAssignment_8_1_1_1_0_0");
					...
					put(grammarAccess.getWhileAccess().getStrAssignment_6_0_0(), "rule__While__StrAssignment_6_0_0");
